...
if __name__ == '__main__':
    ...
    df_train['X_path'] = df_train['X_path'].apply(lambda x: change_home_path(x, home))
    df_train['y_path'] = df_train['y_path'].apply(lambda x: change_home_path(x, home))

    df_test['X_path'] = df_test['X_path'].apply(lambda x: change_home_path(x, home))
    df_test['y_path'] = df_test['y_path'].apply(lambda x: change_home_path(x, home))

    df_val['X_path'] = df_val['X_path'].apply(lambda x: change_home_path(x, home))
    df_val['y_path'] = df_val['y_path'].apply(lambda x: change_home_path(x, home))
